...
const SavedShows = () => {
    ...
    return (
        <>
            <h2 className='text-white font-nsans-bold md:text-xl p-4'>My Shows</h2>
            <div className="relative flex items-center group">
                ...
                <div id={'slider'} className='slider w-full h-full overflow-x-scroll whitespace-nowrap scroll-smooth scrollbar-hide relative'>
                    ...
                    {movies.map((item, id) => (
                        <div key={id} className='w-[160px] sm:w-[200px] md:w-[240px] lg:w-[280px] inline-block cursor-pointer relative p-2'>
                            ...
                            <div className="absolute top-0 left-0 w-full h-full hover:bg-black/80 opacity-0 hover:opacity-100 text-white">
                                ...
                                <p className='whitespace-normal text-xs md:text-sm font-nsans-bold flex justify-center items-center h-full text-center'>
